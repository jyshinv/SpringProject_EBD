...
public class EpisodeCmtDto {

	private int num;
	private String writer;
	private String content;
	private String target_nick; //댓글 대상자
	private int ref_group; //원글의 글번호
	private int cmt_group; //댓글 내에서의 그룹번호
	private String deleted; //삭제된 댓글인지 여부 "yes" or "no"
	private String regdate;
	private int startRowNum; 
	private int endRowNum;
	
	public EpisodeCmtDto() {
		super();
	}

	public EpisodeCmtDto(int num, String writer, String content, String target_nick, int ref_group, int cmt_group,
	...
	public static List<EpisodeCmtDto> getList(EpisodeCmtDto commentDto) {
