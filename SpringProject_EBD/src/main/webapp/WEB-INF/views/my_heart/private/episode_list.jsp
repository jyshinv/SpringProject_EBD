		...
		<ul class="pagination justify-content-center" style="margin-top: 32px;margin-bottom: 32px;">
			<c:choose>
				<c:when test="${startPageNum != 1 }">
					<li class="page-item">
						<a class="page-link" href="my_heart_category.do?pageNum=${startPageNum-1 }&condition=episode">Prev</a>
					</li>
				</c:when>
				<c:otherwise>	
				...
				<c:choose>
					<c:when test="${i eq requestScope.pageNum }">
						<li class="page-item active">
							<a class="page-link"
							href="my_heart_category.do?pageNum=${i }&condition=episode">${i }</a>
						</li>
					</c:when>
					<c:otherwise>
						<li class="page-item">
			...
			<c:choose>
				<c:when test="${endPageNum lt totalPageCount }">
					<li class="page-item">
						<a class="page-link" href="my_heart_category.do?pageNum=${endPageNum+1 }&condition=episode">Next</a>
					</li>
				</c:when>
				<c:otherwise>
					<li class="page-item disabled">
