		...
		<div class="row justify-content-md-center" style="margin:10px;">
			<div class="col-8">
				<select class="form-control" name="condition" id="condition">
					...
					<option value="market" selected>북스마켓</option>
		...
		<ul class="pagination justify-content-center" style="margin-top: 32px;margin-bottom: 32px;">
			<c:choose>
				<c:when test="${startPageNum != 1}">
					<li class="page-item">
						<a class="page-link" href="my_write_category.do?pageNum=${startPageNum-1}&condition=market">Prev</a>
					</li>
				</c:when>
				<c:otherwise>	
				...
				<c:choose>
					<c:when test="${i eq requestScope.pageNum }">
						<li class="page-item active">
							<a class="page-link"  
							href="my_write_category.do?pageNum=${i }&condition=market">${i }</a>
						</li>
					</c:when>
					<c:otherwise>
						<li class="page-item">
			...
			<c:choose>
				<c:when test="${endPageNum lt totalPageCount}">
					<li class="page-item">
						<a class="page-link" href="my_write_category.do?pageNum=${endPageNum+1}&condition=market">Next</a>
					</li>
				</c:when>
				<c:otherwise>
					<li class="page-item disabled">
