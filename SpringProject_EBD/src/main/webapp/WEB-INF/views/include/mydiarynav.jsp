...
<div class="container">
	<table class="table">
		...
		<tr>
			<th></th>
			<td>${sessionScope.nick }</td><!-- dto.id 안됨 -->
		</tr>
		<tr>
			<th></th>
	...
	<nav class="navbar navbar-expand-sm" style="background-color:#F7E9B6">
		<div class="container">
			<button class="navbar-toggler navbar-dark" data-toggle="collapse" data-target="#topNav">
				<span class="navbar-toggler-icon"></span>
			</button>
			<div class="container collapse navbar-collapse" id="topNav">
