...
<nav class="navbar navbar-light navbar-expand-sm fixed-top" style="background-color: #e3f2fd;" >
	<div class="container">
		...
		<form class="form-inline mr-auto">
			<input class="form-control mr-sm-2" type="search" placeholder="검색내용 입력" aria-label="Search">
		...
		<c:choose>
			...
			<c:otherwise>
				<span class="navbar-text">
					...
					<a class="btn btn-secondary btn-sm" href="${pageContext.request.contextPath }/users/logout.do">로그아웃</a>
				</span>
			</c:otherwise>
		</c:choose>
