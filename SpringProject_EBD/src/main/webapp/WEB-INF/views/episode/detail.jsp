...
<div class="container">
	...
	<div class="card mb-3 card-padding">
		...
		<!-- 제목 -->
		<h1 class="card-title" style=" text-align: center; margin-top:30px;">${dataDto.title }</h1>
		<!-- 조회수 등록일 -->
		...
		<!-- 이미지 -->
		<img class="card-img-top episode-img" src="${pageContext.request.contextPath }${dataDto.imgPath}"/>
		<div class="card-body">
			<c:if test="${empty id }">
				<span>♥</span>
			...
			<c:if test="${not empty nick }">
				...
				<c:if test="${dataDto.writer eq nick }">
			    	<a href="private/updateform.do?num=${dataDto.num }"style="color:black;">
					...
					<a href="private/delete.do?num=${dataDto.num }" style="color:black;">
